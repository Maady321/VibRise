...
const LoveLetter = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 z-10 relative">
        <motion.div 
            className="glass p-6 md:p-12 max-w-3xl w-full relative overflow-hidden shadow-2xl my-5 md:my-10"
        ...
        >
            ...
            <h2 className="text-3xl md:text-5xl font-romantic text-rose-600 mb-6 md:mb-8 tracking-wide">My Dearest Rowdy,</h2>
            
            <div className="text-base md:text-2xl text-gray-700 font-body leading-loose min-h-[120px] md:min-h-[150px] tracking-wide mb-6 md:mb-8">
                {displayedText}
